 ...
 * @package ghost.android.hisbeans.coffeestamp
 * @date 2012. 7. 16.
 * @purpose : implements CoffeeStampDao.
 * 				handle database-related job with mybatis.
 *
 */
public class CoffeeStampDaoJdbc implements CoffeeStampDao{
	 ...
	 * 
	 * @throws IllegalStampAccessException when 'count' has too big value
	 * 
	 */
	public void addCoffeeStamps(int stampCardIndex, int count) throws IllegalStampAccessException {
	 ...
	 * 
	 * @param barcodeNumber for identify specific user
	 * @return CoffeeStampModel whose count is full and used flag is false
	 * 
	 */
