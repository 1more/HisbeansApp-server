...
public class PresentCardModel {
	...
	private String nick_name; // this value have 'receiver name' actually.
	...
	/*** Constructors ***/
	public PresentCardModel() {
		super();
	}
	public PresentCardModel(int giftcard_srl, String menu, String message,
