...
public class UserDaoJdbc implements UserDao{
	...
	/** DB에 존재하는 Max sequence number를 구하는 Method
	 * 
	...
	/** 생성한 barcode number를 DB에 추가하는 Method
	 * 
	 * @param barcode - generated barcode number
	 */
	...
	/** id와 일치하는 user barcode를 찾아 return하는 Method
	 * 
	 * @param id
	...
	/** genValidCode에서 생성된 Valid code를 삭제
	 * 
	 * @param id
	...
	/** genValidCode에서 생성된 Valid code를 가지고오는 Method
	 * 
	 * @param id
